...
#	define AV_NOT_IMPLEMENTED do { AV_LOG_ERROR( ::Avokii::LoggingChannels::Assertion, "Function not implemented!" ); AV_DEBUGBREAK(); } while(0)
#else
#	define AV_ASSERT(x, ...) do {} while(0)
#	define AV_ASSERT_CHANNEL(channel, x, ...) do {} while(0)

#	define AV_NOT_IMPLEMENTED do { AV_LOG_ERROR( ::Avokii::LoggingChannels::Assertion, "Function not implemented!" ); } while(0)
#endif
